...
def create_model ():
    ...
    modelName = f'reject_nonexistent_species'
    ...
    model.chemistry.species.symbol.set(np.array(['This name does not correspond with the species name in test.txt', 'H2', 'e-'], dtype='S'))
