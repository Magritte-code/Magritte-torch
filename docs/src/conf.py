...
project = 'Magrittetorch'
copyright = f'{year}, Thomas Ceulemans'
author = 'Thomas Ceulemans'
...
breathe_projects = {'Magrittetorch' : 'doxygen/xml'}
...
html_logo  = 'images/Magrittetorch_logo_no_background.png'
