...
We show how Magrittetorch can be used to post-process snapshots of hydrodynamics simulations.
...
.. Note::
    For general examples on how to generate Magrittetorch models from analytic or tabulated
...
<https://ui.adsabs.harvard.edu/abs/2020MNRAS.499.5194D/abstract>`_) and Ceulemans et al. (in prep). 
